    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">
                ...
                <a href="{{route('questions.create', $quiz->id)}}" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus"></i> Soru Oluştur</a>
            </h5>
                ...
                <tbody>
                    @foreach ($quiz->questions as $question)
                        <tr>
                            ...
                            <td class="text-success">{{substr($question->correctAnswer, -1)}}. Cevap</td>
                            <td>
